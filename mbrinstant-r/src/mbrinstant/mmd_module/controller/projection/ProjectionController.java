...
//    public double countStock(List<StockCardC> list) {
//        double result = 0;
//
//        for (StockCardC stc : list) {
//            result = result + stc.getQty();
//        }
//        return result;
//    }
...
//    }
    ...
    private void openPrintMaterialsDialog() {
        if (!batchRecordList.isEmpty()) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/mbrinstant/mmd_module/view/projection/print_options.fxml"));
    ...
    private void openNewBatchDialog() {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/mbrinstant/mmd_module/view/projection/new_batch.fxml"));
