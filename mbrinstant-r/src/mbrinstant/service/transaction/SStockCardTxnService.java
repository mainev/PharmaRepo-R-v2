 ...
 * @author maine
 */
public class SStockCardTxnService {

    static WebResource webResource;
    static final String BASE_URI = "http://localhost:8080/RedServer-v2/webresources/transaction/stock_card_txn";
    ...
    public static List<StockCardTxn> getReservedAndApprovedtByItemCd(String itemCd) {
    ...
    public static List<StockCardTxn> getReservedAndApprovedtByItemCdAndCompanyCd(String itemCd, String companyCd) {
    ...
    public static StockCardTxn postStockCardTxn(int mbrId, int stkId, StockCardTxn txn) {
