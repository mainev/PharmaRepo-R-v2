 ...
 * @author maine
 */
public class SingletonPackgMaterialRestClientTest {

    public SingletonPackgMaterialRestClientTest() {
    }
    ...
    public void testMethod() {
        try {
            ...
            SingletonPackgMaterialRestClient restClient = SingletonPackgMaterialRestClient.getInstance();
            restClient.setUsernameAndPassword("mainevillarias@gmail.com", "password");

            System.out.println(restClient.getPackgMaterialList());
