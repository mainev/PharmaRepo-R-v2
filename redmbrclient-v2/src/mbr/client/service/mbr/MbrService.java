...
public class MbrService {
    ...
    public Mbr createMbr(Product productId, double batchSize, String batchNo, Date mfgDate, Date expDate,
    ...
    /*
    public int getNoOfBottlesInBatch(List<PackagingMaterialRequirement> pmrList, int bottleId){
    ...
    public int getNoOfCBox(Collection<PackagingMaterialRequirement> pmrList, int cBoxId){
