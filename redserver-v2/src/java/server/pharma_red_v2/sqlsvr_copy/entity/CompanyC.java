 ...
 * @author maine
 */
@Entity(name = "CompanyC")
@Table(name = "company", schema="sqlsvr_copy")
@XmlRootElement
public class CompanyC implements Serializable {
    ...
    public CompanyC(Short id) {
        this.id = id;
    }

    public CompanyC(Short id, String code) {
        this.id = id;
        this.code = code;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CompanyC)) {
            return false;
        }
        CompanyC other = (CompanyC) object;
