...
public class StockCardTxnREST {
    ...
    @GET
    @Path("/get_reserved_approved_by_item_cd")
    @Produces("application/json")
    public List<StockCardTxn> getReservedAndApprovedtByItemCd(@QueryParam("item_cd") String item_cd) {
      ...
      @GET
    @Path("/get_reserved_approved_by_item_cd_company_cd")
    @Produces("application/json")
    ...
    public StockCardTxn create(@QueryParam("mbr_id") String mbr_id, @QueryParam("stk_id") String stk_id, StockCardTxn txn) {
