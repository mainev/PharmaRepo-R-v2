 ...
 */
@Entity
@Table(name = "filling_area_line_clearance", schema = "line_clearance")
@XmlRootElement
public class FillingAreaLineClearance implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FillingAreaLineClearance)) {
            return false;
        }
        FillingAreaLineClearance other = (FillingAreaLineClearance) object;
