 ...
 */
@Entity
@Table(name = "equipment_requirement_coding", schema="mbr")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EquipmentRequirementCoding.findAll", query = "SELECT e FROM EquipmentRequirementCoding e")})
public class EquipmentRequirementCoding implements Serializable {
...
//        @JoinColumn(name = "id", referencedColumnName = "id", nullable = false, insertable = false, updatable = false)})
    ...
    public EquipmentRequirementCoding() {
    }

    public EquipmentRequirementCoding(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EquipmentRequirementCoding)) {
            return false;
        }
        EquipmentRequirementCoding other = (EquipmentRequirementCoding) object;
