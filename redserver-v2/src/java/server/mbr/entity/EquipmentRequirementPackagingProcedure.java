 ...
 */
@Entity
@Table(name = "equipment_requirement_packaging_procedure", schema="mbr")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EquipmentRequirementPackagingProcedure.findAll", query = "SELECT e FROM EquipmentRequirementPackagingProcedure e")})
